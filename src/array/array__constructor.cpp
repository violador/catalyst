// ../src/array/array__constructor.cpp ====================================================== //
//
...
//
//
array::array(const unsigned int &row_size): sizeof_row(row_size),
                                            sizeof_column(0),
                                            sizeof_1st_layer(0),
                                            sizeof_2nd_layer(0),
                                            array_id(tools::random_number<unsigned int>()),
...
array::array(const unsigned int &row_size, 
             const unsigned int &column_size): sizeof_row(row_size),
...
array::array(const unsigned int &row_size, 
             ...
             const unsigned int &layer_size): sizeof_row(row_size), 
                                              sizeof_column(column_size),
...
array::array(const unsigned int &row_size, 
             ...
             const unsigned int &layer2_size): sizeof_row(row_size),
                                               sizeof_column(column_size),
...
//
//
array::array(const array &given): sizeof_row(given.sizeof_row),
