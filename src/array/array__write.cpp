...
//
                    global_log::file.set_width(MAX_PRECISION + SPACE_LENGTH + ARRAY_INDEX_LENGTH);
                    global_log::file.set_right();
                    global_log::file << (size_of_column()%5 >= 1? converter.to_string_from(column_number + 1) : "");
//
                    global_log::file.set_width(MAX_PRECISION + SPACE_LENGTH);
                    global_log::file.set_right();
                    global_log::file << (size_of_column()%5 >= 2? converter.to_string_from(column_number + 2) : "");
//
                    global_log::file.set_width(MAX_PRECISION + SPACE_LENGTH);
                    global_log::file.set_right();
                    global_log::file << (size_of_column()%5 >= 3? converter.to_string_from(column_number + 3) : "");
//
                    global_log::file.set_width(MAX_PRECISION + SPACE_LENGTH);
                    global_log::file.set_right();
                    global_log::file << (size_of_column()%5 >= 4? converter.to_string_from(column_number + 4) : "");
//
                    global_log::file.set_width(MAX_PRECISION + SPACE_LENGTH);
                    global_log::file.set_right();
                    global_log::file << (size_of_column()%5 >= 5? converter.to_string_from(column_number + 5) : "");
//
                    global_log::file.set_new_line();
                    unsigned int m = 0;
