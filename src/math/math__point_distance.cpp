...
//
//
/// @param [in] x1 A templated number: the x-axis value of the first point.
//
/// @param [in] x2 A templated number: the x-axis value of the second point.
//
...
/// @param [in] x1 A templated number: the x-axis value of the first point.
//
/// @param [in] y1 A templated number: the y-axis value of the first point.
//
/// @param [in] x2 A templated number: the x-axis value of the second point.
//
/// @param [in] y2 A templated number: the y-axis value of the second point.
//
...
/// @param [in] y1 A templated number: the y-axis value of the first point.
//
/// @param [in] z1 A templated number: the z-axis value of the first point.
//
/// @param [in] x2 A templated number: the x-axis value of the second point.
//
/// @param [in] y2 A templated number: the y-axis value of the second point.
//
/// @param [in] z2 A templated number: the z-axis value of the second point.
//
/// @brief Calculates the distance between two points by means of their set
