                                ...
                                const unsigned int &given_task)
{
    #pragma omp parallel sections num_threads(7)
    {
        ...
        #pragma omp section
        {
            ...
            global_log::file.write_debug_msg("lcao_wavefunction::sto3g::sto3g()");
            global_log::file.write_debug_msg("lcao_wavefunction::sto3g::sto3g(): Init data for task ", given_task);
            global_log::file.write_debug_msg("lcao_wavefunction::sto3g::sto3g(): Starting the S, T, V and H matrices calculations.");
        }
    }
//
    ...
    #pragma omp parallel sections num_threads(5)
    {
        #pragma omp section
        {
            ...
            if(runtime_setup.settings::state_of(DEBUG_MODE))
            {
                ...
                global_log::file.write_debug_msg("lcao_wavefunction::sto3g::sto3g(): Invoking algorithm::scf::init()");
            }
