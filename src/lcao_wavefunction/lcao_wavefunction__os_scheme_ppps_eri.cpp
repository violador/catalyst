// ../src/lcao_wavefunction/lcao_wavefunction__os_scheme_ppps_eri.cpp ------------------ //
//
...
//              one pp and one ps type orbitals, (ppps)^0, at the Obara-Saika scheme.
//
...
//
//
double lcao_wavefunction::os_scheme_ppps_eri(array &r,                   // The atomic positions onto one axis.
...
//  table I:
    return a*b + c*d + (e + f)/2.0*(alpha + beta + gamma + delta);
}
